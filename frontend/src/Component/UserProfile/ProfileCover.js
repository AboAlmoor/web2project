...
const ProfileCover = () => {
  ...
  const [uploadProfile, setUploadProfile] = useState(
    localStorage.getItem("uploadProfile") || ""
  );
        ...
        <div>
          <div>
            <div className="profileBackgroundsaleh background-image">
              {uploadedImageUrl && isValidUrl(uploadedImageUrl) ? (
                ...
                <img
                  ...
                  style={{ width: "100%", maxHeight: "400px" }}
                  src={
                    "https://mrahkat.net/wp-content/uploads/2019/05/2182.png"
                  }
                  alt=""
                />
              )}
            ...
            <div
              ...
              style={{ marginRight: "80px", position: "relative" }}
            >
              <div
                className={`menuAmeer ${isActive ? "open" : ""}`}
            ...
            <div className="d-sm-flex align-items-start text-center text-sm-start">
              <div
                className="profileAvatar avatar-xxl mt-n5 mb-3"
                style={{
                  width: "210px",
                  height: "190px",
                  marginTop: "-60px",
