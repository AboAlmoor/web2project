  ...
  <section>
    <div className="container py-4">
      ...
      <a className="postcard__img_link" href="#">
              <img className="postcard__img" src={image1} alt="Image Title" />
            </a>
      ...
      <a className="postcard__img_link" href="#">
              <img className="postcard__img" src={image2} alt="Image Title" />  
            </a>
        <div className="postcard__text">
      ...
      <a className="postcard__img_link" href="#">
              <img className="postcard__img" src={image3} alt="Image Title" />
            </a>
        <div className="postcard__text">
      ...
      <a className="postcard__img_link" href="#">
              <img className="postcard__img" src={image4} alt="Image Title" />
            </a>
        <div className="postcard__text">
