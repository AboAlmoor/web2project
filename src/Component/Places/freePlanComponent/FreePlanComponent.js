...
const FreePlan = () => {
  return (
    <div className="freeplan-container my-5" id="onefree">
      <div className="row vertical-center-flex">
        <div className="col-lg-6 my-auto">
          <h2 className="freeplan-title">One free multi-page site</h2>
            <p className="freeplan-description">
        ...
        <div className="col-lg-6">
          <div className="freeplan-card p-4">
            <h4>Our free plan includes</h4>
            <ul className="list-unstyled freeplan-list">
            ...
            <button className="btn btn-primary btn-lg w-100 mt-3">Sign up for free</button>
